...
#                         'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ' + 'абвгдеёжзийклмнопрстуфхцчшщъыьэюя'), # Используемые символы
...
#         "SizeMultiplier": "0.2",  # Коэффициент
#     }
...
if not os.path.exists(path):
    config.create_default()
# config.read()
# for i in (list(config.settings.items('TimeSettings'))):
#     print(i[0])
